...
**Last worked on: 19 September 2026.** Steps 1–29 and 31–43 are deployed.
**Steps 44–50 are merged to `dev` and NOT deployed** — Alok deploys them.
The live server's schema is **0012**; the next deploy runs **three
migrations, 0013, 0014 and 0015**, and `safe-deploy.sh` backs up first.
