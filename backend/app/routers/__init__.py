...
photos.py (material photos), tracking.py (if tracking ever becomes its own
endpoint rather than a field on a shipment), notifications.py (if sending
ever moves from a script to an endpoint).
"""
